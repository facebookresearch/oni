...
def runner_argparser():
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="Name of the python script that describes the run, e.g. sample_factory.runner.runs.doom_battle_hybrid",
    )
    ...
    parser.add_argument(
        ...
        default=-1,
        type=int,
        help="How many experiments can we squeeze on a single GPU (-1 for not altering CUDA_VISIBLE_DEVICES at all)",
    )
    parser.add_argument(
