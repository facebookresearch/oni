...
class TensorBatcher:
    ...
    def cat(self, dict_of_tensor_arrays, macro_batch_size, use_pinned_memory, timing):
        ...
        if tensor_batch is None:
            ...
            for d1, cache_d, key, tensor_arr, _ in iter_dicts_recursively(
                dict_of_tensor_arrays, tensor_batch
            ):
            ...
            with timing.add_time("batcher_mem"):
                for d1, cache_d, key, tensor_arr, cache_t in iter_dicts_recursively(
                    dict_of_tensor_arrays, tensor_batch
                ):
                    offset = 0
                    for t in tensor_arr:
