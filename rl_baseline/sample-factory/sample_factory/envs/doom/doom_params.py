...
def add_doom_env_args(env, parser):
    ...
    p.add_argument(
        "--start_bot_difficulty",
        default=None,
        type=int,
        help="Adjust bot difficulty, useful for evaluation",
    )
    p.add_argument(
        "--timelimit",
        default=None,
        type=float,
        help="Allows to override default match timelimit in minutes",
    )
    p.add_argument(
        "--res_w", default=128, type=int, help="Game frame width after resize"
    )
    p.add_argument(
