...
from utils.decode import encode_message_batch
...
registration.register(
    id="NetHackScore-v1",
    entry_point=NetHackScore,
)


registration.register(
    id="NetHackStaircase-v1",
    entry_point=NetHackStaircase,
)


registration.register(
    id="NetHackStaircaseLvl3-v1",
    entry_point=NetHackStaircaseLvl3,
)


registration.register(
    id="NetHackStaircaseLvl4-v1",
    entry_point=NetHackStaircaseLvl4,
)


registration.register(
    id="NetHackStaircaseContinual-v1",
    entry_point=NetHackStaircaseContinual,
)


registration.register(
    id="NetHackStaircaseLvl3Continual-v1",
    entry_point=NetHackStaircaseLvl3Continual,
)


registration.register(
    id="NetHackStaircaseLvl4Continual-v1",
    entry_point=NetHackStaircaseLvl4Continual,
)


registration.register(
    id="NetHackOracle-v1",
    entry_point=NetHackOracle,
)


registration.register(
    id="NetHackOracleSober-v1",
    entry_point=NetHackOracleSober,
)


# =========== add envs with extended action spaces, which are necessary for advancing further ===========
...
class NetHackStaircaseExtendedActions(NetHackExtendedActionEnv, NetHackStaircase):
...
class NetHackStaircaseLvl3ExtendedActions(
    NetHackExtendedActionEnv, NetHackStaircaseLvl3
):
...
class NetHackStaircaseLvl4ExtendedActions(
    NetHackExtendedActionEnv, NetHackStaircaseLvl4
):
...
class NetHackOracleExtendedActions(NetHackExtendedActionEnv, NetHackOracle):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        NetHackOracle.__init__(self, *args, **kwargs)
        self.actions = EXTENDED_TASK_ACTIONS
        self.action_space = gym.spaces.Discrete(len(self.actions))


class NetHackOracleSoberExtendedActions(NetHackExtendedActionEnv, NetHackOracleSober):
...
registration.register(
    id="NetHackScoreExtendedActions-v1", entry_point=NetHackScoreExtendedActions
)
registration.register(
    id="NetHackStaircaseExtendedActions-v1", entry_point=NetHackStaircaseExtendedActions
)
registration.register(
    id="NetHackStaircaseLvl3ExtendedActions-v1",
    entry_point=NetHackStaircaseLvl3ExtendedActions,
)
registration.register(
    id="NetHackStaircaseLvl4ExtendedActions-v1",
    entry_point=NetHackStaircaseLvl4ExtendedActions,
)
registration.register(
    id="NetHackOracleExtendedActions-v1", entry_point=NetHackOracleExtendedActions
)
registration.register(
    id="NetHackOracleSoberExtendedActions-v1",
    entry_point=NetHackOracleSoberExtendedActions,
)
